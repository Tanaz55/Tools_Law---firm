...
const Appointment = () => {
    ...
    <div className="bg-accent w-full p-8 rounded-sm max-w-[22rem] md:max-w-md mx-auto ">
        ...
        <div className='space-y-[24px] '>
            ...
            <textarea className="resize-none w-full h-[132px] outline-none rounded-sm p-4 font-body text-sm text-gray focus:ring-primary" placeholder="Your message" ></textarea>
