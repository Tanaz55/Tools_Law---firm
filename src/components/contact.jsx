        ...
        <section id='contact' className=" bg-primary text-white min-h-[732px] section">
            <div className="container mx-auto text-center">
                ...
                <p className=" max-w-[540px] mx-auto px-6 lg:px-0 mb-[64px] ">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Recusandae laudantium saepe, iure enim error repudiandae dignissimos deserunt asperiores deleniti excepturi!
                </p>
                {/* form */}
